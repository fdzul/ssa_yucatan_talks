...
![](https://fdzul.github.io/manual_hotspots/images/cover.jpg){.absolute top=205 left=500 width="300"}
...
.wrapper {
    display: grid;
    grid-gap: 2px;
    grid-template-columns: 180px 180px 180px 450px;
...
::: {.box .d}
```{r gauge_blocks_merida,fig.align = "center", out.height='100%', out.width = '100%'}
...
::: {.box .f}
```{r gauge_casos_merida, out.height='100%', out.width = '100%', fig.align = "center"}
